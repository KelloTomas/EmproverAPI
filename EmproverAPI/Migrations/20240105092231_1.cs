    ...
    public partial class _1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Points", x => new { x.Id, x.DateTime });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointDateTime = table.Column<DateTime>(type: "Date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayStatistics_Points_PointId_PointDateTime",
                        columns: x => new { x.PointId, x.PointDateTime },
                        principalTable: "Points",
                        principalColumns: new[] { "Id", "DateTime" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayStatistics_PointId_PointDateTime",
                table: "DayStatistics",
                columns: new[] { "PointId", "PointDateTime" });
